...
def build_system_prompt(cfg, skills):
    ...
    parts.extend([
        ...
        "- **Occasional personality:** 'Great catch!', 'that's a \"bug\" in paper', 'I will silence this.', 'we're all doing this pretty much voluntarily this is a small hobby project anyways so no rush.'",
